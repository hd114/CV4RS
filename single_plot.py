...
def plot_micro_mAP(scenario1benchmark, scenario2benchmark, scenario2lrp03, scenario2lrp06, output_path, max_rounds):
    ...
    if len(scenario2lrp03) >= max_rounds:
        plt.plot(x_values, scenario2lrp03[:max_rounds], marker='o', linestyle='-', color='blue', linewidth=2, label="Scenario 2 LRP 0.98 prun, 0.05 retain, faaz")
...
if __name__ == "__main__":
    ...
    print("Scenario 2 LRP 0.98, 0.05 retain:", scenario2lrp03)
